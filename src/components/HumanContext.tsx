      ...
      <div className="container human-context-container">
        <div className="human-context-visual reveal active">
          <div className="mockup-fade-container">
            <img src="/portal-humano.png" alt="Nutricionista utilizando o BodyGraph no consultório" loading="lazy" width="460" height="613" />
          </div>
        </div>
        <div className="human-context-content reveal active" style={{ transitionDelay: '0.2s' }}>
          ...
          <p>
            Cada recurso do BodyGraph nasceu de uma dor real do consultório, da prescrição à interpretação de exames com inteligência artificial. Menos tempo em tarefa repetitiva, mais presença com o paciente.
          </p>
        </div>
      </div>
    </section>
