      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '36px' }}>
          ...
          <nav className="bg-nav-links">
            ...
            <a href="/#ferramentas" style={navLinkStyle} onMouseEnter={(e) => e.currentTarget.style.color = textColor} onMouseLeave={(e) => e.currentTarget.style.color = textMuted} onFocus={(e) => e.currentTarget.style.color = textColor} onBlur={(e) => e.currentTarget.style.color = textMuted}>Ferramentas</a>
